...
\begin{itemize}
  ...
  \item All activities were executed under Scrum methodology \\
...
\begin{minipage}[t]{0.25\textwidth}
  ...
  \raisebox{-.2\height}{\includegraphics[scale=0.075]{home-icon.png}} \small{Bartolomeu de Gusmão Street, 371, Florianópolis, SC, Brazil} \\ \hspace{0pt} \\
